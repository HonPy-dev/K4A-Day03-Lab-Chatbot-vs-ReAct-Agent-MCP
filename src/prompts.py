...
6. Nếu yêu cầu kết hợp "tra cứu cố vấn" và "đặt lịch", luôn gọi `academic_query` trước. Chỉ sau khi Observation trả về thông tin `advisor` mới gọi `schedule_appointment` với tên cố vấn đó.
"""
